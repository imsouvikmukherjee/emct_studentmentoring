...
<div class="card">
    <div class="card-body">
        <div class="d-flex align-items-center mb-4">
            ...
            <div class="ms-auto">
                <a href="{{ route('user.edit.profile') }}" class="btn btn-outline-primary btn-sm"><i class="bi bi-clock-history"></i> Change Requests</a>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mentor-contact mt-3">
                            ...
                            <p class="d-flex align-items-center mb-0">
                                ...
                                <span>{{$assignedData->mentor_contact ?? 'N/A'}}</span>
